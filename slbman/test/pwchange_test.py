...
def reset_pwd(user_chinese_name, new_pwd):
    ...
    request.add_query_param('PhoneNumbers', "13501141316")
    request.add_query_param('SignName', "邻邻壹")
    request.add_query_param('TemplateCode', "SMS_172738423")
